...
#[inline(always)]
fn get_pl_writer(output_folder_path: &Path, curr_pl: u32, num_pls_per_dir: u32) -> BufWriter<File> {
...
pub fn modify_blocks(
    ...
    // Dictionary table / Postings list trackers
    let mut new_pl_writer =
        get_pl_writer(output_folder_path, dynamic_index_info.last_pl_number + 1, indexing_config.num_pls_per_dir);
