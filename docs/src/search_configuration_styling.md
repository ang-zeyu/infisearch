...
```html
<!-- Replace "v0.8.4" as appropriate -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/ang-zeyu/infisearch@v0.8.4/packages/search-ui/dist/search-ui-basic.css" />
```
...
```html
<!-- Replace "v0.8.4" as appropriate -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/ang-zeyu/infisearch@v0.8.4/packages/search-ui/dist/search-ui-dark.css" />
```
