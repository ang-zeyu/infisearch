...
```html
<!-- Replace "v0.3.3" as appropriate -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/ang-zeyu/morsels@v0.3.3/packages/search-ui/dist/search-ui-basic.css" />
```
...
```html
<!-- Replace "v0.3.3" as appropriate -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/ang-zeyu/morsels@v0.3.3/packages/search-ui/dist/search-ui-dark.css" />
```
