...
```html
<!-- Replace "v0.6.1" as appropriate -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/ang-zeyu/morsels@v0.6.1/packages/search-ui/dist/search-ui-light.css" />
```
...
```html
<!-- Replace "v0.6.1" as appropriate -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/ang-zeyu/morsels@v0.6.1/packages/search-ui/dist/search-ui-basic.css" />
```
...
```html
<!-- Replace "v0.6.1" as appropriate -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/ang-zeyu/morsels@v0.6.1/packages/search-ui/dist/search-ui-dark.css" />
```
