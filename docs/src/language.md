...
```html
<script src="https://cdn.jsdelivr.net/gh/ang-zeyu/infisearch@v0.8.0/packages/search-ui/dist/search-ui.ascii.bundle.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/gh/ang-zeyu/infisearch@v0.8.0/packages/search-ui/dist/search-ui.latin.bundle.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/gh/ang-zeyu/infisearch@v0.8.0/packages/search-ui/dist/search-ui.chinese.bundle.js"></script>
```
