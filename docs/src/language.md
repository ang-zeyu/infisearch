...
```html
<script src="https://cdn.jsdelivr.net/gh/ang-zeyu/morsels@v0.6.2/packages/search-ui/dist/search-ui.latin.bundle.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/gh/ang-zeyu/morsels@v0.6.2/packages/search-ui/dist/search-ui.chinese.bundle.js"></script>
```
